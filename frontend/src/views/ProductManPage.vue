  ...
  <div class="bg-primary-bg font-display text-primary-text dark:text-white/90 dark:bg-background-dark">
    ...
    <div class="w-full h-64 md:h-80 bg-cover bg-center" :style="{ backgroundImage: 'url(' + heroImage + ')' }">
      <div class="w-full h-full flex flex-col justify-center items-center bg-black/30">
        <h1 class="text-white text-4xl md:text-6xl font-bold tracking-tight">Men's Collection</h1>
        <p class="text-white/90 mt-4 text-lg">Discover the latest in luxury fashion for men</p>
      </div>
    </div>
    ...
    <main class="px-4 sm:px-10 lg:px-20 py-10 flex-1">
      <div class="max-w-7xl mx-auto">
        <div class="flex flex-wrap justify-between gap-4 py-4 mb-6">
          <h1 class="text-primary-text dark:text-white text-4xl lg:text-5xl font-black leading-tight tracking-tight">Sản phẩm Nam</h1>
        </div>
...
// State
const heroImage = ref('https://via.placeholder.com/1920x1080?text=Men+Collection')
...
const resetFilters = async () => {
  ...
  // Load lại sản phẩm nam
  await productStore.fetchProductsByGender(0)
}
