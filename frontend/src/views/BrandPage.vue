    ...
    <main class="px-4 sm:px-10 lg:px-20 py-10 flex-1">
      <div class="max-w-7xl mx-auto">
        <div class="flex flex-wrap justify-between gap-4 py-4 mb-6">
          <h1 class="text-primary-text dark:text-white text-4xl lg:text-5xl font-black leading-tight tracking-tight">
            Tất cả sản phẩm
          </h1>
        </div>
        <div class="flex flex-col lg:flex-row gap-12">
          ...
          <aside class="w-full lg:w-[30%] lg:pr-8">
            <div class="sticky top-28 space-y-8">
              ...
              <!-- Gender -->
              <div class="py-6 border-b border-secondary/50">
                <h3 class="text-lg font-semibold mb-4 text-primary-text dark:text-white">Giới tính</h3>
                <div class="space-y-3">
                  <div class="flex items-center">
                    <input
                        class="h-4 w-4 border-secondary text-primary-text focus:ring-accent"
                        ...
                        :value="null"
                    />
                    <label class="ml-3 text-sm text-primary-text dark:text-white/90" for="gender-all">Tất cả</label>
                  </div>
                  <div class="flex items-center">
                    <input
                        class="h-4 w-4 border-secondary text-primary-text focus:ring-accent"
                  ...
                  <div class="flex items-center">
                    <input
                        ...
                        :value="2"
                    />
                    <label class="ml-3 text-sm text-primary-text dark:text-white/90" for="gender-unisex">Unisex</label>
                  </div>
                </div>
              </div>
